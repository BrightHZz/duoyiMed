...
| **Phase 6** (论文撰写) | shared/scientific-writer + shared/humanizer | `company/shared-services/scientific-writer-agent.md` (IMRAD + Assembly + 数值精度); Gate 33项检查: `company/management/company-orchestrator.md#phase6-gate` |
